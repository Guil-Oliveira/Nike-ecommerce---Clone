...
const Inscreva = () => {
        ...
        <div className="inscreva">
            <aside>
                ...
                <form action="">
                    ...
                    <label htmlFor="">
                        <input type="password" name="senha" id="senha-Login" placeholder="Senha" required/><br /></label>
                    <label htmlFor="">
                        <input type="text" name="name" id="name" placeholder="Nome" required/><br /></label>
                    <label htmlFor="">
                        <input type="text" name="sobrenome" id="sobrenome" placeholder="Sobrenome" required/><br /></label>
                    <label htmlFor="">
                        <input type="date" name="aniversario" id="aniversario" placeholder="Data de nascimento" required/>
                        <p>Receba uma recompensa como membro da Nike todos os anos em <br /> seu aniversário.</p>
                        <br /></label>
                    <label htmlFor="">
	...
	<option value="Zâmbia">Zâmbia</option>
                    ...
                    <label htmlFor="small" className="lb"> <input type="radio" name="size" id="small" checked="checked" required/>
                            Masculino</label> 
